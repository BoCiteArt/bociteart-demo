  ...
  function getVisibilityHtml(){
    ...
    return `
      <div
        ...
        Être référencé permet d’être trouvé.

        <br><br>

        Présenter votre activité, votre savoir-faire
        et vos réalisations permet d’être choisi.
      </div>
        ...
        ${
          subscribed
            ...
            : `
              ...
              Votre fiche gratuite comprend uniquement :
      ...
      <input
        id="subscriptionVisibilityCompanyName"
        class="miniField"
        type="text"
        value="${escapeValue(data.companyName || "")}"
        placeholder="Nom de l’entreprise">
      ...
      <input
        id="subscriptionVisibilityActivity"
        class="miniField"
        type="text"
        value="${escapeValue(data.activity || "")}"
      ...
      <input
        id="subscriptionVisibilityPhone"
        class="miniField"
        type="tel"
        value="${escapeValue(data.phone || "")}"
        placeholder="Téléphone">
      ...
      <input
        id="subscriptionVisibilityEmail"
        class="miniField"
        type="email"
        value="${escapeValue(data.email || "")}"
        placeholder="Adresse e-mail">
        ...
        subscribed
          ? `
            <div
              ...
              Votre abonnement vous permet de compléter
              et de valoriser votre entreprise.
            </div>
            ...
            <textarea
              id="subscriptionVisibilityPresentation"
              class="miniField"
              style="min-height:110px;"
              placeholder="Présentez votre entreprise.">${escapeValue(data.presentation || "")}</textarea>
            ...
            <textarea
              id="subscriptionVisibilityKnowHow"
              class="miniField"
              style="min-height:100px;"
              placeholder="Expliquez ce qui vous distingue.">${escapeValue(data.knowHow || "")}</textarea>
            ...
            <textarea
              id="subscriptionVisibilityServices"
              class="miniField"
              style="min-height:100px;"
              placeholder="Présentez vos services.">${escapeValue(data.services || "")}</textarea>
            ...
            <input
              id="subscriptionVisibilityWebsite"
              class="miniField"
              type="url"
              value="${escapeValue(data.website || "")}"
              placeholder="https://">
            ...
            <div
              ...
              <strong>
                Fonctions professionnelles ouvertes
              </strong>

              <br><br>

              • ajouter votre logo ;<br>
              • présenter votre adresse et votre localisation ;<br>
              • indiquer vos horaires et votre zone d’intervention ;<br>
              • publier vos actualités ;<br>
              • montrer vos réalisations ;<br>
              • présenter vos nouveautés et promotions ;<br>
              • recevoir des demandes de devis ;<br>
              • consulter vos statistiques ;<br>
              • participer pleinement aux mutualisations ;<br>
              • découvrir et soutenir les projets de mécénat ;<br>
              • valoriser votre engagement comme mécène local.
            </div>

            <button
              id="subscriptionVisibilityNewsBtn"
              class="choiceBtn"
              type="button"
              style="
                width:100%;
            ...
            <button
              id="subscriptionVisibilityPatronageBtn"
              class="choiceBtn"
              type="button"
              style="
                width:100%;
            ...
            <button
              id="subscriptionDemoDeactivateBtn"
              class="choiceBtn"
              type="button"
              style="
                width:100%;
                ...
                background:#fff;
              ">
              Désactiver l’abonnement de démonstration
            </button>
          `
          : `
            <div
              ...
              ${getLockedFeature(
                ...
                "Ajoutez votre logo afin que les habitants reconnaissent immédiatement votre entreprise."
              )}

              ${getLockedFeature(
                "Présentation de votre entreprise",
                "Expliquez ce que vous faites, ce qui vous distingue et pourquoi les habitants peuvent faire appel à vous."
              )}

              ${getLockedFeature(
                "Savoir-faire et réalisations",
                "Montrez vos compétences, vos métiers et vos réalisations concrètes."
              )}

              ${getLockedFeature(
                "Adresse et localisation",
                "Permettez aux habitants et aux entreprises de savoir précisément où vous trouver."
              )}

              ${getLockedFeature(
                "Actualités et nouveautés",
                "Publiez vos nouveaux services, réalisations, événements et promotions."
              )}

              ${getLockedFeature(
                "Mutualisation",
                "Accédez pleinement aux regroupements pouvant réduire certaines charges de votre entreprise."
              )}

              ${getLockedFeature(
                "Mécénat local",
                "Soutenez des projets utiles à votre ville tout en valorisant discrètement et durablement l’engagement de votre entreprise."
              )}

              ${getLockedFeature(
                "Statistiques",
                "Découvrez combien de personnes consultent votre fiche et ce qui attire leur attention."
              )}
            </div>

            <button
              id="subscriptionOpenArgumentBtn"
              class="choiceBtn"
              type="button"
              style="
                width:100%;
      ...
      <button
        id="subscriptionVisibilitySaveBtn"
        class="choiceBtn"
        type="button"
        style="
          width:100%;
      ...
      <div
        id="subscriptionVisibilityStatus"
        class="muted"
        style="margin-top:10px;">
      </div>
    `;
...
/* ==========================================================
   BO'CITÉART — FINALISATION ENTREPRISE
   NAVIGATION • RETOUR • PIEDS DE PAGE • TEXTES • MUTUALISATION
   ========================================================== */

(function finalizeBociteEntrepriseExperience(){
  ...
  if(window.BOCITEART_ENTREPRISE_FINALIZED_20260714){
    return;
  }

  window.BOCITEART_ENTREPRISE_FINALIZED_20260714 = true;

  const history = [];

  let applying = false;
  let returningBack = false;
  let timer = null;
  ...
  function identifyRoute(title, modal){
    ...
    if(
      ...
      normalizedTitle.includes(
        "faites connaitre votre entreprise"
      )
    ){
      return "visibilite";
    }
    ...
    if(
      ...
      normalizedTitle.includes(
        "acces prive de l entreprise"
      )
    ){
      return "acces_partenaire";
    }
  ...
  function openRoute(route){
    ...
    try{
      ...
      if(route === "home"){
        ...
        if(typeof app.openHome === "function"){
          app.openHome();
        }
      ...
      if(route === "annuaire_local"){

        if(typeof app.openLocalDirectory === "function"){
          app.openLocalDirectory();
          return;
        }

        if(typeof app.openCorrectedDirectory === "function"){
          app.openCorrectedDirectory();
          return;
        }
      }
      ...
      if(route === "annuaire"){
        ...
        if(typeof app.openProfessionalSearch === "function"){
          app.openProfessionalSearch();
          return;
        }

        if(typeof app.openProfessionalDirectory === "function"){
          app.openProfessionalDirectory();
          return;
        }
      }

      if(route === "fiche_entreprise"){

        if(typeof app.openEntrepriseProfile === "function"){
          app.openEntrepriseProfile();
          return;
        }
      }

      if(route === "fiche_publique"){

        if(
          typeof app.openCorrectedVisibilityPreview ===
          "function"
        ){
          app.openCorrectedVisibilityPreview();
          return;
        ...
        if(typeof app.openVisibilityPreview === "function"){
          app.openVisibilityPreview();
          return;
        }
      }

      if(route === "acces_partenaire"){
        ...
        if(typeof app.openPartnerAccess === "function"){
          app.openPartnerAccess();
          return;
        }
      }

      if(
        typeof app.openScreen === "function"
      ){
        app.openScreen(route);
      }
  ...
  function removeOldBackButtons(modal){
    ...
    modal
      ...
      .forEach(function(button){
        ...
        if(
          ...
          text === "retour au tableau de direction"
        ){
          button.remove();
        }
      });
  ...
  function getFiveCompaniesIntroduction(){
    ...
    return `
      ...
      artisans,
      prestataires
      et commerces travaillent près de chez vous
      sans être réellement connus des habitants.
      ...
      Avant de chercher ailleurs,
      commencez par découvrir les compétences
      déjà présentes sur votre territoire.
    `;
  }

  function addFiveCompaniesIntroduction(
    modal,
    route
  ){
    ...
    if(
      modal.querySelector(
        "#bociteFiveCompaniesIntroduction"
      )
    ){
      return;
    }
    ...
    /*
      Suppression des anciennes introductions proches,
      afin de ne pas afficher deux fois la même idée
      sur la même page.
    */
    ...
    modal
      ...
      .forEach(function(box){
        ...
        if(
          ...
          text.includes(
            "seriez vous capable de donner le nom de cinq entreprises"
          )
        ){
          box.remove();
        }
    ...
    if(backButton){
      backButton.after(introduction);
    }else{
      modal.prepend(introduction);
    }
  }

  function removeDuplicateEconomiesBand(modal){
    ...
    modal
      .querySelectorAll(
        '[data-entreprise-screen="economies"],' +
        '[data-unified-entreprise-screen="economies"],' +
        '[data-corrected-screen="economies"]'
      )
      .forEach(function(button){
        button.remove();
      });

    const mutualisationBand =
      modal.querySelector(
        '[data-entreprise-screen="mutualisation"],' +
        '[data-unified-entreprise-screen="mutualisation"],' +
        '[data-corrected-screen="mutualisation"]'
      );

    if(mutualisationBand){

      const text =
        mutualisationBand.querySelector(
          ".entrepriseBandText," +
          ".entrepriseUnifiedBandText," +
          ".entrepriseCorrectionBandText"
        );
  ...
  function addPartnerBandAtEnd(modal){
    ...
    button.onclick = function(event){
      ...
      if(typeof app.openScreen === "function"){
        app.openScreen("direction");
      }
    };
  ...
  function synchronizeHomeBands(modal){
    ...
    window.requestAnimationFrame(
      function(){
        ...
        texts.forEach(function(text){
          ...
          text.style.animation =
            "entrepriseBandScroll 82s linear infinite";
        });
      }
    );
  }

  function isPresentationRoute(route){
  ...
  function addClickablePresentationFooter(
    modal,
    route
  ){

    if(!isPresentationRoute(route)){
      return;
    }

    let footer =
      modal.querySelector(
        "#bociteFinalPresentationFooter"
      );
    ...
    if(!footer){
      ...
      footer.innerHTML = `
        ...
        Découvrez les autres propositions
        de l’espace Entreprise.

        <button
          id="bociteFinalReturnToBandsBtn"
          class="choiceBtn"
          type="button"
          style="width:100%;margin-top:12px;">
          Revenir aux propositions en bandes défilantes
        </button>
      `;
  ...
  function addMutualisationResponseSpace(
    modal,
    route
  ){

    if(route !== "mutualisation"){
      return;
    }

    if(
      modal.querySelector(
        "#bociteCollectiveRequestsAccess"
      )
    ){
      return;
    }
    ...
    box.innerHTML = `
      ...
      Lorsqu’une charge ou un service intéresse
      un nombre important d’entreprises
      ou de commerces,
      les propositions reçues doivent pouvoir
      être consultées et traitées clairement.
      ...
      • consulter les demandes en cours ;<br>
      • consulter les prestataires ayant répondu ;<br>
      • demander des précisions ;<br>
      • comparer les propositions ;<br>
      • enregistrer son choix ;<br>
      • confirmer ou refuser sa participation.

      <button
        id="bociteCollectiveRequestsBtn"
        class="choiceBtn"
        type="button"
        style="width:100%;margin-top:12px;">
        Ouvrir les demandes et propositions
      </button>
    `;
  ...
  function addEditInformationButtons(
    modal,
    route
  ){
    ...
    if(route === "visibilite"){
      ...
      if(
        modal.querySelector(
          "#bociteEditVisibilityInformationBtn"
        )
      ){
        return;
      }
      ...
      const form =
        modal.querySelector(
          "#correctedVisibilityCompanyName," +
      ...
      button.textContent =
        "Modifier les renseignements de mon entreprise";
    ...
    if(route === "fiche_publique"){
      ...
      if(
        modal.querySelector(
          "#bociteEditPublicCompanyCardBtn"
        )
      ){
        return;
      }
  ...
  function replaceMecenatIntroduction(
    modal,
    route
  ){
    ...
    if(
      modal.dataset.mecenatIntroductionFinal ===
      "true"
    ){
      return;
    }
    ...
    const target =
      boxes.find(function(box){
        ...
        return (
          text.includes(
            "connaissez vous reellement le mecenat"
          ) ||
          text.includes(
            "savez vous a qui et a quoi sert le mecenat"
          ) ||
          text.includes(
            "beaucoup d entreprises connaissent peu le mecenat"
          )
        );
      });
    ...
    target.innerHTML = `
      ...
      Beaucoup d’entreprises connaissent mal le mécénat.

      <br><br>

      Certaines pensent qu’il est réservé
      aux grandes entreprises.

      <br><br>

      D’autres imaginent qu’il nécessite
      obligatoirement des moyens financiers importants.
      ...
      un commerce
      ou une structure plus importante
      peut participer à la vie de son territoire.
      ...
      renforce sa présence locale
      et crée de nouveaux liens
      avec les habitants,
      les associations,
      les écoles,
      les clubs
  ...
  function applyFinalCorrections(){
    ...
    try{
      ...
      addFiveCompaniesIntroduction(
        modal,
        route
      );

      replaceMecenatIntroduction(
        modal,
        route
      );

      addClickablePresentationFooter(
        modal,
        route
      );

      addMutualisationResponseSpace(
        modal,
        route
      );

      addEditInformationButtons(
        modal,
        route
      );
  ...
  console.log(
    "✅ Finalisation Entreprise : navigation, textes et pieds de page chargés"
  );
